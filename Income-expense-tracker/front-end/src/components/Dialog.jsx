...
export default function Dialog (){
    ...
    return(
        <dialog id="my_modal_3" className="modal">
                            <div className="w-[792px] h-[412px] modal-box bg-white p-[20px]">
                                <div className="">
                                    <form method="dialog">
                                ...
                                <div className="flex gap-[5px]">
                                    <div $ className=" flex flex-col w-[196px] gap-[5px]">
                                        <div className="flex h-[40px] w-[100%]">
                                        <a className={`w-[160px] h-[40px] text-center flex items-center justify-center rounded-[20px] text-[16px] gap-1 font-normal ${isIncome
                                            ? "bg-transparen text-black"
                                            : "bg-[#0166FF] text-white"}`}onClick={() => income(false)}
                                        >
                                        Expense
                                        </a>
                                        <a
